...
class Zend_Debug
{
    ...
    public static function dump($var, $label=null, $echo=true)
    {
	  ...
	  public static function jdump($var, $label=null, $echo=true) {
        // format the label
        $label = ($label === null) ? '' : rtrim($label) . ' ';
...
//            }
	 ...
	 public static function fdump($var, $label=null) {

        $filename = $_SERVER['DOCUMENT_ROOT'] . '/logs/dump.txt';

        if (!$handle = fopen($filename, 'a')) {
            echo "Cannot open file ($filename)";
        }

        $dump = self::jdump($var, $label, false);
